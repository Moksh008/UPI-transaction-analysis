...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        'h-full px-4 py-4 hidden md:flex md:flex-col w-[300px] flex-shrink-0 border-r border-gray-200',
        className
      )}
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          'h-16 px-4 py-4 flex flex-row md:hidden items-center justify-between w-full border-b border-gray-200'
        )}
        style={{ backgroundColor: '#f7f6f2' }}
        {...props}
      >
